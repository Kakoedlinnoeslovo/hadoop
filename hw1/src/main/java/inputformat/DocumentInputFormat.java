...
//    private static final Logger log = Logger.getLogger(DocumentInputFormat.class.getName());
...
//            throws IOException {
//        System.out.println("Here RecordReader");
...
//
//
//    private static List<Integer> readIndex(FSDataInputStream index_file) throws IOException {
//        int max_doc = 0;
...
//            List<Integer> al = readIndex(input_index);
//
//            int cur_split = 0;
//            long split_size = 0;
//            long offset = 0;
...
//                    max_doc = cur;
//                cur_split++;
//                long bytes_num_for_split = reader.getNumBytesPerSplit();
